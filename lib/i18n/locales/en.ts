...
export const en: Translations = {
  ...
  // Tools (Web Audio, Sprite Generator, AI Music Generator)
  tools: {
    common: {
      generate: 'Generate',
      ...
      todayEstCost: 'Today Est. Cost',
      monthlyGenerated: '30d Generated',
      monthlyEstCost: '30d Est. Cost',
      cacheSaved: 'Cache Saved',
      apiKey: 'API Key',
      apiKeySetup: 'Gemini API Key Setup',
      apiKeyPlaceholder: 'AIza...',
      apiKeySetupDesc: 'You need to get an API key from Google AI Studio to generate sprites.',
      apiKeyLink: 'Get API Key (Free)',
      apiKeyInvalid: 'Invalid API key. Please get a valid key from https://aistudio.google.com/apikey.',
      apiKeyValidating: 'Validating...',
      apiKeyValidationFailed: 'API key validation failed. Please check your network connection.',
      save: 'Save',
      cancel: 'Cancel',
      close: 'Close',
      tips: 'Tips',
      ...
      customPromptEmpty: 'Leave empty to auto-generate prompt.',
    },
    webAudio: {
      title: 'Web Audio Generator',
      description: 'Generate retro game sounds with Web Audio API',
      bgmSettings: 'BGM Settings',
      sfxSettings: 'SFX Settings',
      genre: 'Genre',
      tempo: 'Tempo (BPM)',
    ...
    sprite: {
      ...
      description: 'Generate retro arcade sprites with Gemini AI',
      type: 'Sprite Type',
      style: 'Art Style',
      palette: 'Color Palette',
      size: 'Size',
      descriptionField: 'Description',
      descriptionPlaceholder: 'e.g., knight with sword, red orb, explosion effect',
      frames: 'Animation Frames',
      animationType: 'Animation Type',
      customAnimation: 'Custom Animation Description',
      customAnimationPlaceholder: 'e.g., flapping wings while circling',
      customAnimationNote: 'English input gives better results',
      generateSprite: '🎨 Generate Sprite',
      downloadPNG: '💾 Download PNG',
      tips: {
        tip1: 'More specific descriptions give better results',
        tip2: 'Pixel art works best with smaller sizes (32x32, 64x64)',
        tip3: 'Neon style has glowing effect on dark backgrounds',
        tip4: 'Generate multiple times with same settings for variations',
        tip5: 'API cost is about $0.02 per image (estimated)',
      },
    },
    aiMusic: {
      title: 'AI Music Generator',
      description: 'Generate retro game music with Gemini Lyria',
      musicType: 'Music Type',
      bgm: 'Background Music (BGM)',
      sfx: 'Sound Effect (SFX)',
      genre: 'Genre',
      mood: 'Mood',
      length: 'Length',
      sfxPresets: 'SFX Presets',
      generateMusic: '🎵 Generate Music',
      downloadWAV: '💾 Download WAV',
      musicInfo: 'Music Info',
      type: 'Type',
      tips: {
        tip1: 'BGM is optimized for seamless looping',
        tip2: 'SFX generates short and impactful sound effects',
        tip3: 'Try presets first before using custom prompts',
        tip4: 'Generate multiple times with same settings for variations',
        tip5: 'BGM: $0.05, SFX: $0.02 (estimated cost)',
      },
    },
  },
