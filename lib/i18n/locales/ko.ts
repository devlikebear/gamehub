export const ko = {
  ...
  tools: {
    common: {
      ...
      settings: '설정',
      usage: '사용량',
      todayGenerated: '오늘 생성',
      todayEstCost: '오늘 예상 비용',
      monthlyGenerated: '30일 생성',
      monthlyEstCost: '30일 예상 비용',
      cacheSaved: '캐시 절약',
      apiKey: 'API 키',
      apiKeySetup: 'API 키 설정',
      apiKeyPlaceholder: 'AIza...',
      apiKeySetupDesc: '스프라이트를 생성하려면 Google AI Studio에서 API 키를 발급받아야 합니다.',
      apiKeyLink: 'API 키 발급받기 (무료)',
      apiKeyInvalid: 'API 키가 유효하지 않습니다. https://aistudio.google.com/apikey 에서 올바른 키를 발급받아주세요.',
      apiKeyValidating: '검증 중...',
      apiKeyValidationFailed: 'API 키 검증에 실패했습니다. 네트워크 연결을 확인해주세요.',
      save: '저장',
      cancel: '취소',
      close: '닫기',
      tips: '팁',
      ...
      customPromptEmpty: '비워두면 자동으로 프롬프트가 생성됩니다.',
    },
    webAudio: {
      title: 'Web Audio 생성기',
      description: 'Web Audio API로 레트로 게임 사운드 생성',
      bgmSettings: 'BGM 설정',
      sfxSettings: 'SFX 설정',
      genre: '장르',
      tempo: '템포 (BPM)',
    ...
    sprite: {
      ...
      size: '크기',
      descriptionField: '설명',
      descriptionPlaceholder: '예: 검을 든 기사, 빨간 구슬, 폭발 이펙트',
      frames: '애니메이션 프레임 수',
      animationType: '애니메이션 타입',
      customAnimation: '커스텀 애니메이션 설명',
      customAnimationPlaceholder: '예: 날개 펄럭이며 선회하는 모션',
      customAnimationNote: '영어로 입력하면 더 정확한 결과를 얻을 수 있습니다',
      generateSprite: '🎨 스프라이트 생성',
      downloadPNG: '💾 PNG 다운로드',
      tips: {
        tip1: '구체적인 설명을 입력할수록 원하는 결과를 얻기 쉽습니다',
        tip2: '픽셀 아트는 작은 크기(32x32, 64x64)를 권장합니다',
        tip3: '네온 스타일은 어두운 배경에서 빛나는 효과가 있습니다',
        tip4: '같은 설정으로 여러 번 생성하면 다양한 변형을 얻을 수 있습니다',
        tip5: 'API 비용은 이미지당 약 $0.02입니다 (예상)',
      },
    },
    aiMusic: {
      title: 'AI 음악 생성기',
      description: 'Gemini Lyria로 레트로 게임 음악과 효과음을 생성하세요',
      musicType: '음악 타입',
      bgm: '배경음악 (BGM)',
      sfx: '효과음 (SFX)',
      genre: '장르',
      ...
      type: '타입',
      tips: {
        tip1: 'BGM은 루프 재생에 최적화되어 있습니다',
        tip2: 'SFX는 짧고 강렬한 효과음을 생성합니다',
        tip3: '프리셋을 먼저 시도한 후 커스텀 프롬프트를 사용하세요',
        tip4: '같은 설정으로 여러 번 생성하면 다양한 변형을 얻을 수 있습니다',
        tip5: 'BGM: $0.05, SFX: $0.02 (예상 비용)',
      },
    },
  },
